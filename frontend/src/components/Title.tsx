...
const forumPosts = [
  {
    ...
    content:
      "Finally someone let me out of my cage. Now time for me is nuthin', 'cause I'm countin' no age. Now I couldn't be there, now you shouldn't be scared. I'm good at repairs, and I'm under each snare. Intangible (an y'all), bet you didn't think. So I command you to, panoramic view (you). Look, I'll make it all manageable. Pick and lockable, all and love and I unpackable. Picture you gettin down in a picture tube. Like you lit the fuse. You think it's fictional? Mystical? Maybe. Spiritual hero who appears on you to clear your view. When you're too crazy. Lifeless to those the definition for what life is. Priceless to you because I put you on the hype shit. Did you like it? Got smokin' righteous with one toke. You're psychic among knows possesses you with one go.",
  },
  {
    id: 2,
    username: "Username",
    ...
    <div className="max-w-4xl mx-auto p-4 space-y-4">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm mt-6">
        <div className="flex items-start space-x-3">
          <Avatar className="w-12 h-12">
            <AvatarImage
              src="/src/assets/img/default-user.svg"
              alt="Your avatar"
            />
