  ...
  return (
    <div className="border-black border-solid border-t flex items-center justify-between px-2 pt-2 pb-0 m-0">
      ...
      <div className="flex gap-4">
        <Link to="https://www.facebook.com/samorzad.pk" target="_blank">
          <Facebook className="h-6 w-6 text-blue-600" />
        </Link>
        <Link to="https://www.instagram.com/samorzad_pk/" target="_blank">
          <Instagram className="h-6 w-6 text-pink-600" />
        </Link>
        <Link
          to="https://www.youtube.com/@HejkatuLenka"
          target="_blank"
        ...
        <Link
          ...
          rel="noopener noreferrer"
        >
          <Twitch className="h-6 w-6 text-purple-600" />
        </Link>
        <Link
          to="https://www.linkedin.com/company/sspk---samorz%C4%85d-studencki-politechniki-krakowskiej/posts/?feedView=all"
          target="_blank"
        >
