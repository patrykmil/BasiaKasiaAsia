    ...
    return (
        <div className="border-black border-solid border-t flex items-center justify-between px-2 pt-2 pb-0 m-0">
            ...
            <div className="flex gap-4">
                ...
                <Link to="https://x.com" target="_blank" rel="noopener noreferrer"><Twitter className="h-6 w-6 text-blue-400" /></Link>
                <Link to="https://www.twitch.tv" target="_blank" rel="noopener noreferrer"><Twitch className="h-6 w-6 text-purple-600" /></Link>
