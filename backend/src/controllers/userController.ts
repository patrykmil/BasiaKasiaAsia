...
export class UserController {
  ...
  public getCurrentUser = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const user = await this.userService.getUserById(req.user.userId, true);
  ...
  public getUserByNickname = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const user = await this.userService.getUserByNickname(nickname as string, true);
  ...
  public loginUser = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const user = await this.userService.getUserByEmail(normalizedEmail, true);
